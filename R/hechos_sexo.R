#' hechos_sexo
#'
#' @description Datos que contienen el número total de violaciones de los derechos humanos en Ecuador por tipo de violación y sexo de la víctima.
#' @usage data(hechos_sexo)
...
#' @format Un data frame con 12 filas y 3 variables:
#' \describe{
...
#'   \item{violacion}{Número total de violaciones de los derechos humanos.}
#' }
"hechos_sexo"
